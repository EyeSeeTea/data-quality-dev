        ...
        <>
            ...
            <StyledTableHead>
                <TableRow className={classes.bottomBorder}>
                    ...
                    {currentColumns.map(column => {
                        return (
                            <TableCell
                                key={`data-table-cell-${String(column.name)}`}
                                align="left"
                                sortDirection={
                                    field === String(column.name) && column.sortable ? order : false
                                }
                            >
                                <TableSortLabel
            ...
            {contextMenuTarget && (
                <ContextualMenu
                    ...
                    positionLeft={contextMenuTarget?.[0] ?? 0}
                    positionTop={contextMenuTarget?.[1] ?? 0}
