...
import { ReferenceObject, TableColumn, TablePagination, TableSorting } from "$/webapp/components/data-table/types";
...
function hasKey(node: ReactNode): node is ReactNode & { key: string } {
    return _.isObject(node) && "key" in node;
}
